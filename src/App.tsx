...
import { Zap, Crosshair, Trophy, Skull, Play, RotateCcw, Swords, Hexagon, Flame } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  const [stats, setStats] = useState({ atk: 100, spd: 3.0, proj: 1, fever: 0, feverActive: false });
        ...
        <div className="absolute bottom-0 left-0 right-0 z-20 pointer-events-none">
           ...
           <div className="w-full px-6 mb-2">
               ...
               <div className="flex justify-end items-center mb-1">
                   ...
                   <Flame size={14} className={stats.feverActive ? 'text-[#FFD700]' : 'text-slate-500'} fill="currentColor" />

               </div>

               <div className="h-2 w-full bg-[#1A1A24] border border-white/10 relative overflow-hidden">

                   <div 

                      className={`h-full transition-all duration-200 ${stats.feverActive ? 'bg-[#FFD700] shadow-[0_0_10px_#FFD700]' : 'bg-[#FF2A6D]'}`}

                      style={{ width: `${Math.min(100, stats.fever)}%` }}
           ...
           <div className="bg-[#0B0B15]/95 text-white backdrop-blur-xl p-3 border-t border-white/10 flex justify-between items-center">
               ...
               <div className="flex flex-col items-center w-1/3 border-r border-white/5">
                   ...
                   <div className="flex items-center gap-2 text-[#FF2A6D] mb-1">
                       ...
                       <span className="text-xs font-bold tracking-widest opacity-80">攻击力</span>

                   </div>

                   <span className="text-2xl font-bold drop-shadow-[0_0_5px_rgba(255,42,109,0.8)]">{stats.atk}</span>
               ...
               <div className="flex flex-col items-center w-1/3 border-r border-white/5">
                   ...
                   <div className="flex items-center gap-2 text-[#05D9E8] mb-1">
                       ...
                       <span className="text-xs font-bold tracking-widest opacity-80">攻速</span>

                   </div>

                   <span className="text-2xl font-bold drop-shadow-[0_0_5px_rgba(5,217,232,0.8)]">{stats.spd}</span>
               ...
               <div className="flex flex-col items-center w-1/3">
                   ...
                   <div className="flex items-center gap-2 text-[#00FF9C] mb-1">
                       ...
                       <span className="text-xs font-bold tracking-widest opacity-80">弹道数</span>

                   </div>

                   <span className="text-2xl font-bold drop-shadow-[0_0_5px_rgba(0,255,156,0.8)]">{stats.proj}</span>
