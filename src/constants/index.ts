...
export const FEVER_CHARGE_KILL = 1.5;

export const FEVER_CHARGE_LOOT = 20;
...
export const COLORS = {
  ...
  GATE_BG_MYSTERY: 'rgba(160, 32, 240, 0.15)',

  GATE_BORDER_MYSTERY: '#A020F0',

  GATE_BG_TRADE: 'rgba(255, 140, 0, 0.15)',

  GATE_BORDER_TRADE: '#FF8C00',
